...
const buttonVariants = cva(
    'tc-inline-flex tc-items-center tc-justify-center tc-py-2 tc-gap-x-2 tc-whitespace-nowrap tc-rounded-lg tc-text-sm tc-font-medium tc-transition-colors focus-visible:tc-outline-none focus-visible:tc-ring-1 focus-visible:tc-ring-ring disabled:tc-pointer-events-none disabled:tc-opacity-50 [&_svg]:tc-pointer-events-none [&_svg]:tc-size-4 [&_svg]:tc-shrink-0',
    {
        variants: {
            variant: {
                default: 'tc-bg-primary tc-text-primary-foreground tc-shadow hover:tc-bg-foreground/80',
                destructive:
                    'tc-bg-destructive tc-text-destructive-foreground tc-shadow-sm hover:tc-bg-destructive/90',
                outline:
                    'tc-border tc-border-primary/5 tc-bg-background tc-text-primary tc-shadow-sm hover:tc-bg-background/90  hover:tc-text-primary',
                secondary: 'tc-bg-secondary tc-text-secondary-foreground tc-shadow-sm hover:tc-bg-secondary',
